...
UI
- refaktorisati da se na jedno mestu podešava RPG običan ili minimal/white style za sve elemente (uvodni ekran, pauza, završni ekran, kontrole, kamera, energija, score...)
