...
export default class extends Scena3D {
  ...
  async init() {
    ...
    this.stars = new Stars({ minRadius: 150 })
  ...
  sceneUI() {
    ...
    return /* html */`
      <div class="top-left">
        Score: ${points}
        <br><small class="">Fuel left: ${this.lander.fuel}</small>
      </div>
    `
  }
  ...
  update(dt, time) {
    ...
    this.stars.update({ delta: dt * .005 })
